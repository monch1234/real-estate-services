        ...
        <div className="about-us">
            ...
            <div className="size">
                <div className="logo-partners">
                    ...
                    <br />
                    <br />
                    <h2>{translate('about.us1')}</h2>
                    <p>1. {translate('about.us2')} </p>
                    <br />
                    <br />
                    <p>
                        2.  {translate('about.us3')}
                    </p>
                    <br />
                    <br />
                    <p>
                        3.  {translate('about.us4')}
                    </p>
                    <br />
                    <br />
                    <p>
                    ...
                    <br />
                    <br />
                    <p>1. {translate('about.us8')}</p>
                    <p>2. {translate('about.us9')}</p>
                    <p>3.{translate('about.us10')}</p>
                </div>
                <div className="about">
